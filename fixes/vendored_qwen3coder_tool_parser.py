...
class Qwen3CoderToolParser(ToolParser):
    ...
    def extract_tool_calls_streaming(
        ...
        if not self.is_tool_call_started:
            ...
            # P61C-V2-DEFER-UNTIL-FUNCTION: defer commit until <function= header follows the
...
# [PN73T] Alias so "qwen3_coder" -> Qwen3EngineToolParser resolves to this
# legacy non-engine tool parser (engine_based_streaming defaults False -> legacy
# streaming; deferred-commit fix baked in for prose <tool_call>).
Qwen3EngineToolParser = Qwen3CoderToolParser
