...
# [PN73] Alias so the lazy registration ("qwen3" -> Qwen3ParserReasoningAdapter)
# resolves to this legacy non-engine parser (engine_based_streaming defaults False
# -> legacy streaming path -> no Rust <tool_call> content-drop regression).
Qwen3ParserReasoningAdapter = Qwen3ReasoningParser
