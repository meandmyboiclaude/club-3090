...
# dev491 (nightly-1033ffac): upstream made the placeholder increment a
# multi-line `+= (self.num_sampled_tokens_per_step + cur_num_spec_tokens)`.
# Synthetic fixture mirrors that so the re-anchored ASYNC_SCHED_OLD matches.
ASYNC_SCHED_PY_OLD = (
