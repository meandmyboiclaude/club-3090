...
"""SNDR Core patches — `quantization` family.

FP8 / NVFP4 / modelopt quantization patches

Stage 6 (2026-05-07): 3 patches reorganized here from
...
__all__ = [
    "p81_fp8_block_scaled_m_le_8",
    "p91_autoround_row_group_cdiv",
    "pn77_fp8_lm_head",
]
