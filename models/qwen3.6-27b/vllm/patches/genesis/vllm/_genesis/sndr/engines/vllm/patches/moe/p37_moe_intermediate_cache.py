...
GENESIS_P37_MARKER = "Genesis P37 MoE intermediate cache pool v7.0_v11.3.0_hotpath"
...
_NEW = (
    "    # [Genesis P37 v2 — hot-path optimized] Shared MoE intermediate-\n"
    "    # cache pool. All MoE layers execute sequentially with identical\n"
    "    # config, so one pool is safe. Saves ~553 MiB × N_moe_layers\n"
    "    # allocator churn per step on Qwen3.6-35B-A3B chunked-prefill.\n"
    "    # v2: cache the acquire callables in this module's globals on\n"
    "    # first call — eliminates per-MoE-forward import overhead\n"
    "    # (~56-96 imports per step on 35B-A3B = real TPS).\n"
    "    if intermediate_cache13 is None:\n"
    ...
    "            except Exception:\n"
    "                _g_p37_acq13 = False\n"
    "            globals()['_GENESIS_P37_acquire_cache13'] = _g_p37_acq13\n"
    "        if _g_p37_acq13:\n"
    "            intermediate_cache13 = _g_p37_acq13(\n"
    ...
    "            except Exception:\n"
    "                _g_p37_acq2 = False\n"
    "            globals()['_GENESIS_P37_acquire_cache2'] = _g_p37_acq2\n"
    "        if _g_p37_acq2:\n"
    "            intermediate_cache2 = _g_p37_acq2(\n"
