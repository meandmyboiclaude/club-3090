...
KNOWN_STATES = frozenset({
    ...
    "retired",
    "legacy",
    # `coordinator` (added 2026-05-06): patches with no real binding;
    # only flip an env flag that another patch reads at apply-time.
    # First user: P5b → P5 (v1/v2 body selection).
    "coordinator",
})
