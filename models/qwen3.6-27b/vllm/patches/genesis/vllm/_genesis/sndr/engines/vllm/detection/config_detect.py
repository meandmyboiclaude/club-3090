...
def _recommend_for_patches(profile: dict[str, Any]) -> dict[str, Any]:
    ...
    # P56 + P57 archived 2026-05-05 to Genesis_internal_docs/_archive/
    # dead_patches/p56_p57_tq_specdec_deadends/. Both were dead-end attempts
    # to fix #40831; real fix is P65 (TQ CG downgrade) on full-attention path.
