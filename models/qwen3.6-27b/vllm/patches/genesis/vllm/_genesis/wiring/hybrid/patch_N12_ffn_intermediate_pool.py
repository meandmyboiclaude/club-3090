...
# REBASE 2026-07-13 (nightly-9e57de71, dev1060): upstream added a
# `forward_cpu` (POWERPC dispatch) method to SiluAndMul between
# `forward_xpu` and the SiluAndMulWithClamp registration — anchor tail
# extended to include it. forward_cuda body itself is unchanged.
# NOT dev799-compatible (forward_cpu does not exist there; framework
